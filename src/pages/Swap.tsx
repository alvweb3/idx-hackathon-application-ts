...
const Swap: React.FC = () => {
  ...
  //     `/swap/v6.0/1/approve/allowance?tokenAddress=${tokenOne.address}&walletAddress=${address}`
  //   );
  ...
  //     `/swap/v6.0/1/swap?fromTokenAddress=${tokenOne.address}&toTokenAddress=${tokenTwo.address}&amount=${tokenOneAmount?.padEnd(tokenOne.decimals + (tokenOneAmount?.length || 0), '0')}&fromAddress=${address}&slippage=${slippage}`
  //   );
    ...
    <>
      ...
      <div className="tradeBox">
        ...
        <div
          ...
          //style={{ cursor: !tokenOneAmount || !isConnected ? "not-allowed" : "pointer" }}
